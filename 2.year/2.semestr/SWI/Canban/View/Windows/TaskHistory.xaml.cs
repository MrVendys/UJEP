        ...
        public void CreateData(UserModel loggedUser, TaskModel oldTask, TaskModel newTask, DateTime timeOfUpdate)
        {
            ...
            if(propertyList != null)
            {
                ...
                TaskHistoryModel taskHistoryModel = new TaskHistoryModel()
                {
                    ...
                    OldDeadline = propertyList.Contains("Deadline") ? (DateTime)oldPropertyValue[propertyList.IndexOf("Deadline")] : oldTask.Deadline.Date,
                    NewDeadline = propertyList.Contains("Deadline") ? (DateTime)newPropertyValue[propertyList.IndexOf("Deadline")] : oldTask.Deadline.Date,
                    OldCompleted = propertyList.Contains("Completed") ? (DateTime)oldPropertyValue[propertyList.IndexOf("Completed")] : oldTask.Completed.Date,
                    NewCompleted = propertyList.Contains("Completed") ? (DateTime)newPropertyValue[propertyList.IndexOf("Completed")] : newTask.Completed.Date,
                    OldStarted = propertyList.Contains("Started") ? (DateTime)oldPropertyValue[propertyList.IndexOf("Started")] : oldTask.Started.Date,
                    NewStarted = propertyList.Contains("Started") ? (DateTime)newPropertyValue[propertyList.IndexOf("Started")] : newTask.Started.Date,
